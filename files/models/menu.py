...
if auth.user:
    response.menu = [
        ...
        (T('Tools'), False, '#', [
                (T('Live Map Tracking'), False, URL('CaCDemos', 'livetracking')),
                (T('Devices'), False,URL('CaCDemos', 'devices')),
                (T('Device History'), False, URL('CaCDemos', 'device_history')),
                (T('Demo Test'), False, URL('default', 'demoindex1'))
            ]),
        ]
